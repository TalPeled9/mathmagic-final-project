    ...
    <div className="min-h-screen bg-parchment">
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row items-center gap-8">
        <div className="flex-1">
          <img src={logoImg} alt="MathMagic" className="h-10 mb-8" />
          ...
          <h1 className="text-4xl font-bold text-gray-800 leading-tight mb-6">
            Help your child discover the magic of mathematics through interactive stories and playful
            adventures that are tailored for him.
          </h1>
        ...
        <div className="flex-shrink-0">
          <img src={wizzyImg} alt="Wizzy the wizard" className="w-64 md:w-72" />
        </div>
      </section>
    </div>
  );
