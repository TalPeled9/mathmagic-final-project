...
const CATEGORY_GRADIENTS: Record<string, string> = {
  ...
  'addition-subtraction': 'linear-gradient(160deg, #fcb5a5 0%, #f87942 45%, #a84836 100%)',
  ...
  'multiplication-division': 'linear-gradient(160deg, #7dd3fc 0%, #1d7aa8 45%, #0a3a5c 100%)',
  ...
  'odd-even': 'linear-gradient(160deg, #a3e635 0%, #22c55e 45%, #166534 100%)',
  'place-value': 'linear-gradient(160deg, #4ade80 0%, #059669 45%, #065f46 100%)',
  ...
  'prime-composite': 'linear-gradient(160deg, #dcfce7 0%, #22c55e 45%, #1b4332 100%)',
...
const TOPIC_CATEGORY_MAP: Record<string, string> = {
  ...
  g2_addition_subtraction: 'addition-subtraction',
  g3_addition_subtraction: 'addition-subtraction',
  ...
  g4_long_multiplication_division: 'multiplication-division',
